        ...
        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <li>
              <Link
                to={"/market-place"}
                className={`nav-link px-2 text-white ${active("home")}`}
              >
                Market place
              </Link>
            </li>
            <li>
              <Link
                to={"/orders"}
                className={`nav-link px-2 text-white ${active("orders")}`}
              >
                Orders
              </Link>
            </li>
            <li>
              <Link
                to={"/users"}
                className={`nav-link px-2 text-white ${active("users")}`}
              >
                Users
              </Link>
            </li>
            <li>
              <Link
                to={"/operations"}
                className={`nav-link px-2 text-white ${active("operations")}`}
              >
                Operations
              </Link>
            </li>
          ...
          <div className="text-end">
            <Link to={"/settings"} className={"text-white"}>
              <i className="lni lni-user" style={{ color: "#FFF" }}></i>
            </Link>
